...
// ---------------------------------------------------------------------------
// Sub-komponen inline (agar tidak perlu file terpisah di sesi ini)
// ---------------------------------------------------------------------------
</script>

<script>
// SidebarItem & SidebarGroup didefinisikan sebagai komponen global
// di main.js (akan didaftarkan di sesi berikutnya).
// Sementara ini, mereka adalah stub agar layout bisa di-import.
</script>

 ...
 *  - /survey/*        → EmployerLayout (role: employer, token-based)
...
const OtpRequestPage     = () => import('@/views/auth/OtpRequestPage.vue')
const OtpVerifyPage      = () => import('@/views/auth/OtpVerifyPage.vue')
const EmployerAccessPage = () => import('@/views/auth/EmployerAccessPage.vue')

// Admin
const AdminDashboard          = () => import('@/views/admin/DashboardPage.vue')
const AdminAlumniIndex        = () => import('@/views/admin/alumni/IndexPage.vue')
const AdminAlumniDetail       = () => import('@/views/admin/alumni/DetailPage.vue')
const AdminAlumniImport       = () => import('@/views/admin/alumni/ImportPage.vue')
const AdminEmployerIndex      = () => import('@/views/admin/employer/IndexPage.vue')
const AdminEmployerDetail     = () => import('@/views/admin/employer/DetailPage.vue')
const AdminSurveyPeriods      = () => import('@/views/admin/survey/PeriodsPage.vue')
const AdminQuestionnaires     = () => import('@/views/admin/survey/QuestionnairesPage.vue')
const AdminQuestionnaireEdit  = () => import('@/views/admin/survey/QuestionnaireEditPage.vue')
const AdminInvitations        = () => import('@/views/admin/survey/InvitationsPage.vue')
const AdminReports            = () => import('@/views/admin/ReportsPage.vue')
const AdminNotifications      = () => import('@/views/admin/NotificationsPage.vue')
const AdminUsers              = () => import('@/views/admin/system/UsersPage.vue')
const AdminSettings           = () => import('@/views/admin/system/SettingsPage.vue')
const AdminAuditLog           = () => import('@/views/admin/system/AuditLogPage.vue')

// Alumni
const AlumniHome          = () => import('@/views/alumni/HomePage.vue')
const AlumniProfile       = () => import('@/views/alumni/ProfilePage.vue')
const AlumniEmployment    = () => import('@/views/alumni/EmploymentPage.vue')
const AlumniSurvey        = () => import('@/views/alumni/SurveyPage.vue')
const AlumniSurveyFill    = () => import('@/views/alumni/SurveyFillPage.vue')

// Employer
const EmployerSurveyFill  = () => import('@/views/employer/SurveyFillPage.vue')
const EmployerSurveyDone  = () => import('@/views/employer/SurveyDonePage.vue')

// Misc
const UnauthorizedPage = () => import('@/views/errors/UnauthorizedPage.vue')
...
const routes = [
  // Root redirect berdasarkan role
  {
    ...
    name: 'home',
    redirect: () => {
      // Dihandle oleh navigation guard global
      return { name: 'login' }
    },
  },
  ...
  // ── ADMIN ─────────────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      // Sistem (superadmin only — guard di route guard global)
      {
        path: 'users',
        name: 'admin.users',
...
router.beforeEach(async (to) => {
  // Lazy-load auth store (hindari circular import)
